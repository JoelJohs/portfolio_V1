...
const ProjectCard = ({ project }) => {
  return (
    <div className="bg-card-gradient backdrop-blur-md border border-opacity-20 border-accent rounded-lg p-6 transition-transform duration-300 ease-in-out transform hover:translate-y-[-10px] hover:scale-105 hover:shadow-lg hover:border-accent relative overflow-hidden w-full max-w-md mx-auto">
